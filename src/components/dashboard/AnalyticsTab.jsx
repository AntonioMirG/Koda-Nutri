  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <motion.div variants={itemVariants} className="card-white p-6 shadow-sm-soft border border-silver-mist lg:col-span-2">
        ...
        <motion.div variants={itemVariants} className="card-white p-6 border border-silver-mist">
        ...
        {/* 4. Weight Progress */}
        <motion.div variants={itemVariants} className="card-white p-6 border border-silver-mist md:col-span-2 lg:col-span-2">
